...
$id = $_GET['id'];
$room = $db->query("SELECT * FROM rooms WHERE id = {$id}")->fetch(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="zxx">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="rd-reviews">
                        ...
                        * FROM reviews WHERE rooms_id={$id}")->fetchAll(PDO::FETCH_ASSOC);
                ...
                <div class="col-lg-4">
                    <div class="room-booking">
                        ...
                        <form action="handler/reservation.php" method="post">
